...
# Get OpenCV v3.4.5 and Contrib Source
WORKDIR /usr/local/src
RUN git clone --depth 1 -b '3.4.5' https://github.com/opencv/opencv.git \
    && git clone --depth 1 -b '3.4.5' https://github.com/opencv/opencv_contrib.git \
